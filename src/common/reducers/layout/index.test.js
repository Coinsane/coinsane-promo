...
import { UI_WINDOW_RESIZE } from 'actions/layout';
...
describe('LAYOUT REDUCER', () => {
  ...
  describe('Mobile properties WINDOW_RESIZE', () => {
    ...
    it('should handle WINDOW_RESIZE with 1280px screen', () => {
      expect(reducer(initialState, windowResize(1280)))
        .toEqual({
          sidebarOpened: true,
          innerWidth: 1280,
        });
